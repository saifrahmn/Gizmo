...
---
<svg {width} {height} {...props}>{title ? (<title>{title}</title>) : ""}<rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>